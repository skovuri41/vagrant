...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>devbox/user-provision.sh at master · stuartsierra/devbox</title>
    ...
    <meta property="fb:app_id" content="1401488693436528"/>
      ...
      <meta content="@github" name="twitter:site" /><meta content="summary" name="twitter:card" /><meta content="stuartsierra/devbox" name="twitter:title" /><meta content="devbox - Provisioning scripts for my personal development workstation" name="twitter:description" /><meta content="https://1.gravatar.com/avatar/55878d0196b91803f9cb2c372b0551d3?d=https%3A%2F%2Fidenticons.github.com%2F4d5b287c22a1c2eddea787ac0d70aac1.png&amp;r=x&amp;s=400" name="twitter:image:src" />
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://1.gravatar.com/avatar/55878d0196b91803f9cb2c372b0551d3?d=https%3A%2F%2Fidenticons.github.com%2F4d5b287c22a1c2eddea787ac0d70aac1.png&amp;r=x&amp;s=400" property="og:image" /><meta content="stuartsierra/devbox" property="og:title" /><meta content="https://github.com/stuartsierra/devbox" property="og:url" /><meta content="devbox - Provisioning scripts for my personal development workstation" property="og:description" />
...
<meta content="DtpsH2W0gRViUMWWXHMWB6EOXf61UVrQwbYrsFyHpT4=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-14b928cef61596f6df7a9f2e108bba2fb0743455.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="d9f8cc42b9a72eb627a5c32534baf7a6">
        ...
        <link data-pjax-transient rel='permalink' href='/stuartsierra/devbox/blob/10c46e3d2e889d5a6b152ddf48d1f20a87358055/user-provision.sh'>
...
<!-- blob contrib key: blob_contributors:v21:ea7b9bc5d3e780c934e1a86fbe07d8bf -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/stuartsierra/devbox/blob/master/user-provision.sh"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="breadcrumb">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/stuartsierra/devbox" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">devbox</span></a></span></span><span class="separator"> / </span><strong class="final-path">user-provision.sh</strong> <span class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="user-provision.sh" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>


  <div class="commit file-history-tease">
    <img alt="Stuart Sierra" class="main-avatar js-avatar" data-user="95044" height="24" src="https://2.gravatar.com/avatar/55878d0196b91803f9cb2c372b0551d3?d=https%3A%2F%2Fidenticons.github.com%2F4d5b287c22a1c2eddea787ac0d70aac1.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img alt="Stuart Sierra" class=" js-avatar" data-user="95044" height="24" src="https://2.gravatar.com/avatar/55878d0196b91803f9cb2c372b0551d3?d=https%3A%2F%2Fidenticons.github.com%2F4d5b287c22a1c2eddea787ac0d70aac1.png&amp;r=x&amp;s=140" width="24" />
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards"
               href="github-windows://openRepo/https://github.com/stuartsierra/devbox?branch=master&amp;filepath=user-provision.sh" aria-label="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton tooltipped upwards js-update-url-with-hash"
                   aria-label="Clicking this button will automatically fork this project so you can edit the file"
                   href="/stuartsierra/devbox/edit/master/user-provision.sh"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/stuartsierra/devbox/raw/master/user-provision.sh" class="button minibutton " id="raw-url">Raw</a>
            <a href="/stuartsierra/devbox/blame/master/user-provision.sh" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/stuartsierra/devbox/commits/master/user-provision.sh" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/stuartsierra/devbox/delete/master/user-provision.sh"
...
<span id="L17" rel="#L17">17</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c">#!/usr/bin/env bash</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="c"># User-level provisioning for Ubuntu 12.04 (Precise Pangolin)</span></div><div class='line' id='LC4'><span class="c">#</span></div><div class='line' id='LC5'><span class="c"># This script should run as a normal non-root user.</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="nb">set</span> -e</div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="k">if</span> <span class="o">[[</span> -e /vagrant <span class="o">]]</span><span class="p">;</span> <span class="k">then</span></div><div class='line' id='LC10'><span class="k">    </span><span class="nv">SOURCES</span><span class="o">=</span>/vagrant</div><div class='line' id='LC11'><span class="k">else</span>  <span class="c"># for packer</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nv">SOURCES</span><span class="o">=</span>/tmp</div><div class='line' id='LC13'><span class="k">fi</span></div><div class='line' id='LC14'><span class="nb">source</span> <span class="s2">&quot;$SOURCES/provision-functions.sh&quot;</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>install_lein</div><div class='line' id='LC17'>install_dotfiles</div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04032s from github-fe139-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
